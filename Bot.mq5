...
input int MagicStart = 7925; // Magic Number, kind of...
class c
{
		public:
...
// Block 1 (Hours filter)
class Block0: public MDL_HoursFilter<string,string,string,bool,string,string,bool,string,string,bool,string,string>
{
...
class Block3: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
